    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                print '    <button id="openButton" class="btn btn-secondary" type="button" onclick="window.open(\'' . $beyond->config->get('base', 'server.baseUrl') . ($dir['relPath'] !== '' ? '/' . $dir['relPath'] : '') . '/' . $editFile . '\',\'_blank\');">Open in new tab</button>' . PHP_EOL;
